...
class ProtocolHandler(object):
    def handle_request(self, socket_file):
        # Parse a request from the client into it's components parts
        pass
...
class Server(object):
    def __init__(self, host='127.0.0.0', port=31337, max_clients=64):
    ...
    def connection_handler(self, conn, address):
        ...
        # Proccess client requests until clients disconnects
        while True:
            try:
